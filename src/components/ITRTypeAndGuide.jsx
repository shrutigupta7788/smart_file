...
const ITRTypeAndGuide = () => (
  <div className="min-h-screen flex-1 bg-gradient-to-br from-purple-50 to-blue-50 px-0 flex flex-col items-center" style={{paddingBottom: 0, marginBottom: 0}}>
    <div className="w-full max-w-full bg-white shadow-2xl p-16 pb-0 mb-0" style={{paddingBottom: 0, marginBottom: 0}}>
      <h2 className="text-4xl md:text-5xl font-extrabold text-purple-700 mb-10">Type of Income Tax Return Form</h2>
      ...
      <h3 className="text-2xl font-semibold mb-4 text-purple-700">Income Tax E-filing Due Date</h3>
      <p className="mb-8 text-gray-800 text-lg">The due date of E-filling of income tax returns depends upon the taxpayer. If the taxpayer is individual, body of individuals, association of persons, Hindu undivided family then the due date for filling income tax return is July 31 every financial year. However, for business and companies which require audit the date for filling income tax return is September 30 every financial year. For any person who is required to furnish report in form No. 32CEB under section 92E the date for filling income tax return is November 30 every financial year. If the taxpayer does not file the income tax return in time, then he will have to pay the late fee along with the tax payable.</p>
      <h3 className="text-2xl font-semibold mb-4 text-purple-700">What are the Benefits or Advantages of Income Tax Return Filing?</h3>
      ...
      <h3 className="text-2xl font-semibold mb-4 text-purple-700">Documents Required for Income Tax eFiling</h3>
      <ul className="list-disc pl-12 mb-8 space-y-2 text-gray-800 text-lg">
      ...
      <h3 className="text-2xl font-semibold mb-4 text-purple-700">Who can file online income tax return</h3>
      <ul className="list-disc pl-12 mb-8 space-y-2 text-gray-800 text-lg">
      ...
      <h3 className="text-2xl font-semibold mb-4 text-purple-700">Points to be Considered During Efiling of ITR</h3>
      <ul className="list-disc pl-12 mb-8 space-y-2 text-gray-800 text-lg">
      ...
      <h3 className="text-2xl font-semibold mb-4 text-purple-700">Steps to File Income Tax Return eFiling Online</h3>
      <ol className="list-decimal pl-12 mb-8 space-y-2 text-gray-800 text-lg">
        ...
        <li>If not, then you will receive a form ITR-V which is an acknowledgement and verification. You can print the same and sign using blue pen and then post it to the income tax department within 120 days of e-filling at: Income Tax Department – CPC, Post Bag No – 1, Electronic City Post Office, Bengaluru – 560100 within 120 days of e-filing. You will then receive an acknowledgement of receipt of ITR-V by email and SMS.</li>
      </ol>
      <h3 className="text-2xl font-semibold mb-4 text-purple-700">Conclusion for Income Tax Return</h3>
      <p className="mb-0 text-gray-800 text-lg">Every taxpayer whether it be an individual, Hindu undivided family, company association of persons, Company etc all have to file income tax returns to the income tax departments. Filling income tax return is very simple and can be done online also.</p>
    </div>
  </div>
);

export default ITRTypeAndGuide; 